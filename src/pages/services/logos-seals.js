...
const title = 'Logo Design Services'

const desc = jsondata.fullname +  " provides advanced " + title + " for businesses of all sizes."
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link rel="canonical" href="https://familymarketing.us/services/logos" />
        <meta
          name="description"
          content={desc}
        />
