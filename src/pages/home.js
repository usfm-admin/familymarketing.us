    ...
    <div>
      ...
      <section className="flex flex-col p-3">
        <div className="bg-white border rounded-lg min-w-full p-5 mb-5">
          ...
          <p className="text-sm">
            Host our websites for free without worrying about Cpanel or clunky interfaces. USFM offers everything you need and 24/7 customer support. We deploy our content on the <a className="text-blue-400 hover:text-blue-500" href="https://vercel.com" target="_blank">Vercel</a> network, a service that allows deployment of <a className="text-blue-400 hover:text-blue-500" href="https://nextjs.com" target="_blank">NextJS</a> and <a className="text-blue-400 hover:text-blue-500" href="https://reactjs.org" target="_blank"> React</a> apps. Vercel also allows us to offer every custom of ours a free SSL certificate on their website. We also offer custom on-site computer solutions for hosting websites yourself.
                      </p>
        </div>
        <div className="bg-white border rounded-lg min-w-full p-5 mb-5">
          <img
          ...
          <p className="text-sm">
       Our website design templates are A+ tested on Google Lighthouse, meaning they will offer superior performance, SEO, and PWA functionality. 
          </p>
        </div>
        <div className="bg-white border rounded-lg min-w-full p-5 mb-5">
          <img
          ...
          Build your dream website without breaking the bank. We offer packages starting at $9.99 per month. 
          <p className="text-sm">
         </p>
        </div>
      </section>
