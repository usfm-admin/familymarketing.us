            ...
            <section className="bg-sky-100 p-8">
                ...
                <p className="text-sm">
                    United States Family Marketing offers a unique approach to digital
                              ...
                              Custom Email/Website Servers, Logo Design & Business Cards.{" "} </p>
                <Link to="/contact">
            ...
            <section className="flex flex-col p-3">
                <div className="bg-white border rounded-lg min-w-full p-5 mb-5">
                    ...
                    <p className="text-sm">
                        ...
                        <a className="text-blue-400 hover:text-blue-500" href="https://vercel.com" target="_blank" rel="noreferrer">
                            Vercel
                        </a>
                        {" "}
                        network, a service that allows deployment of{" "}
                        <a className="text-blue-400 hover:text-blue-500" href="https://nextjs.com" target="_blank" rel="noreferrer">
                            NextJS
                        </a>
                        {" "}
                        and{" "}
                        <a className="text-blue-400 hover:text-blue-500" href="https://reactjs.org" target="_blank" rel="noreferrer">
                            {" "}
                            React
                        </a>
                        {" "}
